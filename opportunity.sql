...
CREATE TABLE IF NOT EXISTS `Opportunity` (
  ...
  `amount` int (250) unsigned  NOT NULL,
...
--
ALTER TABLE `Opportunity`
  ADD CONSTRAINT `FK_products` FOREIGN KEY (`accid`) REFERENCES `Accounts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
